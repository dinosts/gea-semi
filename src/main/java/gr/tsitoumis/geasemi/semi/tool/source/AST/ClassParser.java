package gr.tsitoumis.geasemi.semi.tool.source.AST;

import java.io.BufferedReader;
import java.io.FileReader;
import java.util.ArrayList;

import gr.tsitoumis.geasemi.semi.tool.source.gui.LongMethodDetector;
...
public class ClassParser {
    ...
    public void parse() {
        ...
        if (LongMethodDetector.DebugMode) {
            System.out.println("done in " + Utilities.getDuration(start, System.currentTimeMillis()));
        }
    }
}
